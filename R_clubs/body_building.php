...
<head>
    ...
    <title title="MOUAU Body builder Team">Mouau Body Builder Club</title>
                   ...
                   <ul class="nav navbar-nav">
                      ...
                      <li><a href="#" title="click to send us a message" data-toggle="modal" data-target="#contact_us">Contact Us</a> </li>
                       <li class="dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Body Building team">Body BuildingClub<span class="caret"></span></a>
                       ...
                       <li><a href="#" title="click to view our body building videos on youtube" target="_blank">Youtube Channel <span class="glyphicon glyphicon-camera"></span></a></li>
                   </ul>
