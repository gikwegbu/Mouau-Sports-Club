...
<head>
    ...
    <title title="MOUAU table tennis Team">Mouau Table TennisClub</title>
                   ...
                   <ul class="nav navbar-nav">
                      ...
                      <li><a href="#" title="click to send us a message" data-toggle="modal" data-target="#contact_us">Contact Us</a> </li>
                       <li class="dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="tabletennis team">Table Tennis Club<span class="caret"></span></a>
                         <ul class="dropdown-menu">
                             <li><a href="basketball.php" title="clisk to view our basketball page">Basketball</a> </li>
                       ...
                       <li><a href="#" title="click to view our table tennis videos on youtube" target="_blank">Youtube Channel <span class="glyphicon glyphicon-camera"></span></a></li>
                   </ul>
