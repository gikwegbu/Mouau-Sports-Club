...
<head>
    ...
    <title title="MOUAU physical Team">Mouau Physical Fitness Club</title>
                   ...
                   <ul class="nav navbar-nav">
                      ...
                      <li><a href="#" title="click to send us a message" data-toggle="modal" data-target="#contact_us">Contact Us</a> </li>
                       <li class="dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="physical fitness team">Physical fitness Club<span class="caret"></span></a>
                         <ul class="dropdown-menu">
                                <li><a href="basketball.php" title="click to view ourbasketball page">Basketball </a> </li>
                           ...
                           <li class=divider></li><!--this sets a division line from balling sports and other sports-->
                             <li><a href="boxing.php" title="click to view our boxing page">Boxing</a> </li>
                       ...
                       <li><a href="#" title="click to view our physical fitness videos on youtube" target="_blank">Youtube Channel <span class="glyphicon glyphicon-camera"></span></a></li>
                   </ul>
