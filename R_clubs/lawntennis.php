...
<head>
    ...
    <title title="MOUAU Lawn tennis Team">Mouau Lawn Tennis Club</title>
                   ...
                   <ul class="nav navbar-nav">
                      ...
                      <li><a href="#" title="click to send us a message" data-toggle="modal" data-target="#contact_us">Contact Us</a> </li>
                       <li class="dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Lawntennis team">Lawn Tennis Club<span class="caret"></span></a>
                       ...
                       <li><a href="#" title="click to view our lawn tennis  videos on youtube" target="_blank">Youtube Channel <span class="glyphicon glyphicon-camera"></span></a></li>
                   </ul>
